...
export const ERROR_CODES = {
  ...
  // ---------- 리포트 (RP) — R은 이력서가 선점해 두 글자 접두사 ----------
  /** 404 — 리포트를 찾을 수 없습니다. */
  REPORT_NOT_FOUND: "RP001",
  /** 403 — 해당 리포트에 접근할 권한이 없습니다. */
  REPORT_FORBIDDEN: "RP002",
  /** 409 — 리포트 생성이 진행 중입니다. 완료 후 다시 시도해 주세요. */
  REPORT_GENERATION_IN_PROGRESS: "RP003",
  /** 409 — 리포트 생성이 실패한 상태입니다. 재생성을 요청해 주세요. */
  REPORT_GENERATION_FAILED: "RP004",
  /** 409 — 완성된 리포트는 재생성할 수 없습니다. */
  REPORT_RETRY_NOT_ALLOWED: "RP005",
  /** 500 — 리포트 재생성 요청에 실패했습니다. 잠시 후 다시 시도해 주세요. */
  REPORT_GENERATION_REQUEST_FAILED: "RP006",
