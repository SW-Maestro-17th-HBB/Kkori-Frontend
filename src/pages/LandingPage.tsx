...
export function LandingPage() {
  ...
  const feats = [
    {
      t: "이력서 기반 맞춤 질문",
      d: "올린 이력서를 그대로 읽고, 당신의 경력과 프로젝트에서 나올 법한 질문을 만들어요.",
    },
    {
      t: "실시간 음성 면접",
      d: "타이핑이 아니라 목소리로. 실제 면접관처럼 답변을 듣고 꼬리질문까지 이어가요.",
    },
    {
      t: "끝나면 바로 리포트",
      d: "논리·구체성·전달력을 점수로. 무엇을 고쳐야 할지 다음 연습 과제까지 짚어드려요.",
    },
  ];
  return (
    <div style={{ background: "var(--bg-canvas)" }}>
      ...
      <section style={{ maxWidth: 1120, margin: "0 auto", padding: "36px 28px 0" }}>
        ...
        >
          ...
          >
            <span style={{ width: 6, height: 6, borderRadius: "50%", background: "#fff" }} /> AI
            음성 모의면접
          </div>
          <h1
            style={{
          ...
          >
            당신의 이력서를 읽고 실제 면접관처럼 꼬리질문까지. 면접이 끝나면 무엇을 고쳐야 할지
            리포트로 알려드려요.
          </p>
          <div style={{ display: "flex", gap: 12, marginTop: 30, justifyContent: "center" }}>
            <Button
              variant="solid"
              size="lg"
              style={{ background: "#fff", color: "var(--blue-800)" }}
              onClick={() => nav("auth")}
            >
              무료로 시작하기
            </Button>
        ...
        <div style={{ display: "flex", justifyContent: "center" }}>
          ...
          >
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              ...
              >
                <span
                  style={{ width: 7, height: 7, borderRadius: "50%", background: "var(--red-600)" }}
                />{" "}
                예시 리포트 · REC 04:12
              </span>
